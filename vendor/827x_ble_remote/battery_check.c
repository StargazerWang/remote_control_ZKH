...
void battery_percent(void)
{
    /*if(batt_vol_mv>3000){
       my_batVal[0] = 100;
        ...
        my_batVal[0] = 90 + (batt_vol_mv-2800)/20 ;
   }
   else if (batt_vol_mv > 2600){
        my_batVal[0] = 70 + (batt_vol_mv-2600)/10 ;
   }
   else if (batt_vol_mv > 2400){
        my_batVal[0] = 40 +  (batt_vol_mv-2400)/7 ;
   }
    else if (batt_vol_mv > 2200){
        my_batVal[0] = 10 +  (batt_vol_mv-2200)/7 ;
   } else  {
        my_batVal[0] = 0;
   }*/
    if(batt_vol_mv>3000){
   ...
   // printf("\n1111111111bak_batpercent=[%d] batt_vol_mv=%d,my_batVal=%d \r\n",bak_batpercent, batt_vol_mv,my_batVal[0]);
    if(bak_batpercent > my_batVal[0])
    {
        if(bak_batpercent - my_batVal[0] > 10)
        {
             bak_batpercent = my_batVal[0];
             ...
             printf("\n122222222batt_vol_mv=%d,my_batVal=%d \r\n",batt_vol_mv,my_batVal[0]);
        }
        else{
            bak_batpercent = my_batVal[0];
        }
    ...
    {
        //printf("\n333333333333333ak_batpercent=%d,my_batVal=%d \r\n",bak_batpercent,my_batVal[0]);    
        if( my_batVal[0] - bak_batpercent > 30)
        {
             bak_batpercent = my_batVal[0];
             if(device_in_connection_state)
             {
             ...
             printf("\n222222222222batt_vol_mv=%d,my_batVal=%d \r\n",batt_vol_mv,my_batVal[0]);
        }else{
            my_batVal[0] = bak_batpercent;
            //printf("\n333333333333333ak_batpercent=%d,my_batVal=%d \r\n",bak_batpercent,my_batVal[0]);  
        }
    }
}
